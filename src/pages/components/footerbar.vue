  ...
  <div class="footer">
    <div class="main-position">
        ...
        <div class="emoji-package" v-show="showEmoji">
          <div class="qq_face">
            <a
              ...
              @click="addImage(index, item.title)"
            ></a>
          </div>
        </div>
        <div class="right">
      ...
      <div class="ad-footer" v-if="adFooter">
        <a
          href="http://a.app.qq.com/o/simple.jsp?pkgname=com.wisexs.xstv&amp;channel=0002160650432d595942&amp;fromcase=60001"
        >
...
export default {
  ...
  methods: {
    ...
    doShare () {
      // 分享
      if (window.SZJSBridge) {
        window.PalauAPI.share(
          'all',
          this.details.title.toString(),
          this.HTMLDecode(this.details.introduce),
          window.location.href,
          this.details.img_src,
          res => {
            if (res == 0) {
              this.$message({
                message: '分享失败',
